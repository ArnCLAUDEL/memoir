...
% TODO more emphasis on technical test during the implementation phase
% TODO unit tests
% TODO integration tests
% TODO more preparation means better result
% TODO add a schema of the v-model
% TODO mention some tool like Junit, Mockito
% TODO include a bug fix cost chart

\subsection{Residual limits}\label{subsec:residual-limits}
% TODO documentation problems
% TODO dev and analysts are seperated
