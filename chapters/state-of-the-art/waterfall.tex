...
% TODO tests are written now (or possibly in parallel of the dev)
% TODO a test plan is made using the ALM tool
% TODO test plan is executed using the ALM tool
% TODO defects and proof of validation are reported
% TODO round trip when defects are detected
% TODO delivry once there's no more (major) defect
